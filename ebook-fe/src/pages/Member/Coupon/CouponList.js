...
// import coupon from '../../../img/coupon.png'
// // import couponz from '../../../img/test-coupon.png'
// import coupons from '../../../img/coupons.png'
...
//                     </div>
//                     <div className="ms-5">
//                       <Typography variant="h5" className="text-success">{c.Coupon_name}</Typography>
//                       <Typography variant="h4" className="text-success">${c.Coupon_discount}</Typography>
...
import ScrollToTop from './Component/ScrollToTop'
import couponData from './marketing.json'
import { Coupon } from './CouponSelect'
// import couponData from './coupon.json'
import business from '../../../img/business.png'
import lecture from '../../../img/novel.png'
import social from '../../../img/social.png'
...
// import couponz from '../../../img/test-coupon.png'
import '../../../img/coupon-stroke.png'
import '../../../img/coupon-light.png'
import axios from 'axios'
import { API_URL } from '../../../utils/config'
import { useAuth } from '../../../Context/auth'
...
function CouponList() {
  ...
  const onSelected = (e) => {
    ...
    switch (index) {
      case '1':
        cTemp = [...coupons].sort(
          (a, b) => new Date(a.Coupon_edte) - new Date(b.Coupon_edte)
        )
        break
      case '2':
        cTemp = [...coupons].sort(
            ...
            coupons.map((c, i) => (
              <div className="" key={`coupon${i}`}>
                <div className="d-flex coupon-size mb-5">
                  ...
                  <div className="coupon-text-margin">
                    <h3 className="text-warning">{c.Coupon_name}</h3>
                    <h1 className="text-warning">${c.Coupon_discount}</h1>
                    <h5 className="text-warning">{c.Coupon_edte}</h5>
                    <h5 className="text-warning">{c.Coupon_code}</h5>
                  </div>
                </div>
              </div>
            ))}
