...
function CouponList() {
  ...
  const onSelected = (e)=>{
    ...
    switch(index){
      case '1':
        cTemp = [...coupons].sort((a,b)=>(
          new Date(a.Coupon_sdte) - new Date(b.Coupon_sdte)
        ));
        break;
      case '2':
        cTemp = [...coupons].sort((a,b)=>(
          new Date(b.Coupon_sdte) - new Date(a.Coupon_sdte)
        ));
        break;
        cTemp = [...coupons].sort((a,b)=>(
          new Date(b.Coupon_edte) - new Date(a.Coupon_edte)
        ));
        break;
      case '3':
        cTemp = [...coupons].sort((a,b)=>(
          parseInt(a.Coupon_discount) - parseInt(b.Coupon_discount)
        ));
        break;
      case '4':
        cTemp = [...coupons].sort((a,b)=>(
          parseInt(b.Coupon_discount) - parseInt(a.Coupon_discount)
        ));
        break; 
      default:
        cTemp = [...coupons].sort((a,b)=>(
      ...
      {/* 麵包屑 */}
        ...
        <div className="d-flex justify-content-end me-2">
          <div className="coupon-dropdown col-3 mb-4 dp me-5 oprator">
            ...
            <select className='coupon-select' name="op" id="op" onChange={onSelected}>
              <option className='coupon-option' value="1">日期舊到新</option>
              <option className='coupon-option' value="2">日期新到舊</option>
              <option className='coupon-option' value="3">折扣少到多</option>
              <option className='coupon-option' value="4">折扣多到少</option>
            </select>
          </div>
        </div>
        <div className="d-flex flex-wrap">
